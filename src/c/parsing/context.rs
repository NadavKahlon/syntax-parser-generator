...
impl CParserContext {
    ...
    pub fn int_literal(&mut self, lexeme: String) -> Option<CParserNode> {
        Some(CParserNode::Expression(ast::Expression::IntLiteral { value: lexeme.parse().ok()? }))
    }

    pub fn empty_program(&mut self) -> Option<CParserNode> {
        Some(CParserNode::AbstractProgram(ast::AbstractProgram { global_statements: vec![] }))
    }

    pub fn add_global_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                                -> Option<CParserNode>
    {
        let mut program = CParserNode::take_abstract_program(
            &mut satellites, 0);
        program.global_statements.push(
            Box::new(CParserNode::take_global_statement(&mut satellites, 1)));
        Some(CParserNode::AbstractProgram(program))
    }

    pub fn function_definition(&mut self, mut satellites: Vec<Option<CParserNode>>)
                               -> Option<CParserNode>
    {
        Some(CParserNode::GlobalStatement(ast::GlobalStatement::FunctionDefinition {
    ...
    pub fn one_item_formal_arg_list(&mut self, mut satellites: Vec<Option<CParserNode>>)
                                    -> Option<CParserNode>
    {
    ...
    pub fn add_formal_arg(&mut self, mut satellites: Vec<Option<CParserNode>>)
                          -> Option<CParserNode>
    {
        let mut formal_arg_list = CParserNode::take_formal_arg_list(
            &mut satellites, 0);
    ...
    pub fn formal_arg(&mut self, mut satellites: Vec<Option<CParserNode>>)
                      -> Option<CParserNode>
    {
    ...
    pub fn add_local_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                               -> Option<CParserNode>
    {
        let mut local_statement_list = CParserNode::take_local_statement_list(
            &mut satellites, 0);
        let local_statement = CParserNode::take_local_statement(
            &mut satellites, 1);
        local_statement_list.push(Box::new(local_statement));
        Some(CParserNode::LocalStatementList(local_statement_list))
    }

    pub fn local_variable_declaration(&mut self, mut satellites: Vec<Option<CParserNode>>)
                                      -> Option<CParserNode>
    {
        Some(CParserNode::LocalStatement(ast::LocalStatement::VariableDeclaration {
            name: CParserNode::take_identifier(&mut satellites, 1),
            dtype: Box::from(CParserNode::take_dtype(&mut satellites, 0)),
        }))
    }

    pub fn local_evaluation(&mut self, mut satellites: Vec<Option<CParserNode>>)
                            -> Option<CParserNode>
    {
        Some(CParserNode::LocalStatement(ast::LocalStatement::Evaluation {
            expression: Box::from(CParserNode::take_expression(&mut satellites, 0)),
        }))
    }

    pub fn block_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                           -> Option<CParserNode>
    {
    ...
    pub fn if_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                        -> Option<CParserNode>
    {
    ...
    pub fn if_else_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                             -> Option<CParserNode>
    {
    ...
    pub fn while_statement(&mut self, mut satellites: Vec<Option<CParserNode>>)
                           -> Option<CParserNode>
    {
    ...
    pub fn variable_expression(&mut self, mut satellites: Vec<Option<CParserNode>>)
                               -> Option<CParserNode>
    {
    ...
    pub fn assignment(&mut self, mut satellites: Vec<Option<CParserNode>>)
                      -> Option<CParserNode>
    {
    ...
    pub fn identifier_lvalue(&mut self, mut satellites: Vec<Option<CParserNode>>)
                             -> Option<CParserNode>
    {
    ...
    pub fn int_dtype(&mut self, _satellites: Vec<Option<CParserNode>>)
                     -> Option<CParserNode>
    {
